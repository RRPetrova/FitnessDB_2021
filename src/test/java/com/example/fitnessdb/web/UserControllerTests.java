...
public class UserControllerTests {
    ...
    public void registerNewUserTest() throws Exception {
        ...
        mockMvc.perform(post("/users/register")
                        ...
                        .param("phoneNumber", "1231-45-67-88")
                        .with(csrf()))
    ...
    @Test
    public void registerWithWrongFieldType() throws Exception {
//        UserEntity user = new UserEntity();
//        UserRegisterBinignupWdingModel userRegisterBindingModelTest = new UserRegisterBindingModel();
//        userRegisterBindingModelTest
//                .setFirstName("Testche")
//                .setPhoneNumber("1235-45-67-98")
//                .setUsername("test")
//                .setPassword("test123")
...
//                .setEmail("test@test.bg");
  ...
  this.mockMvc.perform(post("/users/register")
                        ...
                        .param("password", "testP")
                        .param("confirmPassword", "testP")
                        .param("phoneNumber", "1235-45-67-98")
                        .with(csrf()))
