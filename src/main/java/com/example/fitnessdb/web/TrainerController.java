...
public class TrainerController {
    ...
    @GetMapping("/all")
    @PreAuthorize("hasRole('ADMIN')")
    public String allFreeTrainers(Model model) {
        model.addAttribute("allFreeTrainers", this.trainerService.getAllFreeTrainers());
        return "trainers";
    }
    ...
    public String removeTrainer(@PathVariable Long id) {
        this.trainerService.removeTrainerById(id);
